...
@Component({
  ...
  template: `
    <div class="search-field">
      <input #input (keydown.enter)="searchString(input.value)" (keydown.esc)="removeSearch()" [attr.disabled]="loading?'':null" type="text" placeholder="Søg nu for pokker" class="text-center"> {{input.focus()}}
    </div>
    `
